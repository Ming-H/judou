...
- **术语点读**：内置百条财报术语词典（科目/指标/报表概念/公司事件），点击带底线术语即出白话释义与「读时看什么」（程序匹配，零 AI 成本）；词典未收录的词，AI 结合本页原文解释并明说有无依据
- **划词工具条**：划选任意文本浮出「换算 / 解释 / 提问」工具条——点词查义，一键引用原文提问
- **巨潮导入**：站内搜索公司（真实调用巨潮接口），一键拉取财报正本/全部公告入库，公告 URL 与发布日期溯源、内容 hash 去重
